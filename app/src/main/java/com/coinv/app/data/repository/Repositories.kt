...
class DashboardRepository @Inject constructor(
    ...
    fun observeRecentMemories(): Flow<List<MemoryEntity>> = memoryDao.observeAll()
    ...
    fun observeRecommendations(): Flow<List<LiveRecommendation>> =
        cognitiveRepository.observeTimeline().flatMapLatest {
            flow { emit(cognitiveRepository.buildRecommendations()) }
        }
...
class MemoryRepository @Inject constructor(
    ...
    fun observeAll() = memoryDao.observeAll()
    fun search(query: String) = memoryDao.search(query)
